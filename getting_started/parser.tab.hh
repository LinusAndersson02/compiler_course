  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_CLASS = 31,                            // CLASS
        S_MAIN = 32,                             // MAIN
        S_INT_TYPE = 33,                         // INT_TYPE
        S_FLOAT_TYPE = 34,                       // FLOAT_TYPE
        S_BOOLEAN = 35,                          // BOOLEAN
        S_VOLATILE = 36,                         // VOLATILE
        S_VOID = 37,                             // VOID
        S_IF = 38,                               // IF
        S_ELSE = 39,                             // ELSE
        S_FOR = 40,                              // FOR
        ...
        S_FALSE = 47,                            // FALSE
        S_LENGTH = 48,                           // LENGTH
        S_IF_NO_ELSE = 49,                       // IF_NO_ELSE
        S_UMINUS = 50,                           // UMINUS
        S_YYACCEPT = 51,                         // $accept
        S_program = 52,                          // program
        S_global_var_list = 53,                  // global_var_list
        S_opt_newlines = 54,                     // opt_newlines
        S_class_list = 55,                       // class_list
        S_class_decl = 56,                       // class_decl
        S_class_body = 57,                       // class_body
        S_class_member_list = 58,                // class_member_list
        S_class_member = 59,                     // class_member
        S_class_member_tail = 60,                // class_member_tail
        S_param_list_opt = 61,                   // param_list_opt
        S_param_list = 62,                       // param_list
        S_param = 63,                            // param
        S_entry = 64,                            // entry
        S_stmt_block = 65,                       // stmt_block
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_IF_NO_ELSE ()
      {
        return symbol_type (token::IF_NO_ELSE);
      }
#else
      static
      symbol_type
